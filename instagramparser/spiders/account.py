...
class AccountSpider(scrapy.Spider):
    ...
    target_profiles = ['delta', 'mosgortrans']
    ...
    def followers_parse(self, response: HtmlResponse, username, user_id, variables):
        ...
        for follower in followers:
            profile = {
                ...
                'private': follower['node']['is_private'],
                'verified': follower['node']['is_verified'],
                'linked_user_id': user_id,
                'linked_username': username
            }
            yield InstagramparserItem(**profile)
    ...
    def followings_parse(self, response: HtmlResponse, username, user_id, variables):
        ...
        for following in followings:
            profile = {
                ...
                'private': following['node']['is_private'],
                'verified': following['node']['is_verified'],
                'linked_user_id': user_id,
                'linked_username': username
            }
            yield InstagramparserItem(**profile)
